export const PT_BR = {
    ...
    AchievementRotterdam100Desc: "Ganhe 100 dinheiros suíço em Rotterdã numa única corida",
    AchievementRotterdam500: "Wind Mill Owner",
    AchievementRotterdam500Desc: "ganhe 500 dinheiros suíço em Rotterdã numa única corida",
    AchievementRotterdam1000: "Wind Turbine Owner",
    AchievementRotterdam1000Desc: "ganhe 1000 dinheiros suíço em Rotterdã numa única corida",
    ...
    ElectricCarDesc: "Fábircas de automóveis utilizam baterias ao invés de petróleo e só necessitam da 50% da quantidade",
    HongKongBonusV2:
    ...
    GasPropellantFactory: "Fábrica de propulsor à gás",
    ...
    BattleshipFactory: "Fábrica de navio de guerra",
    ...
    PumpkinBatteryDesc: "Todos os edificios que consomem bateria utilizam abóbora (POLÍTICA GRATUITA)",
    PumpkinSteel: "Pumpkin Steel",
    PumpkinSteelDesc: "Todos os edificios que consomem aço utilizam abóbora (POLÍTICA GRATUITA)",
};
